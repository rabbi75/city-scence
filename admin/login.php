          ...
          <div class="form-inner">
            ...
            <?php
              ...
              if (isset($_POST['submit'])) {
                ...
                $sql = "SELECT username,password FROM spi_admin WHERE username='$loginUsername' AND password= md5('$loginPassword') AND status = 1";
                ...
                if ($loginUsername!='') {
                  if ($loginPassword!='') {
                    if($coun>0) {
                      $_SESSION['phpcoder'] = $loginUsername;
                      header('location:?page=dashboard');
                    }else{
                       echo '
                  ...
                  <strong>Error!</strong>Please Your User Name Or Password Not Match!</div>';
                   ...
                   <div class="alert alert-danger alert-dismissible" role="alert">
                   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</  span></button>
                  <strong>Error!</strong>Please Fill Up Your Password!</div>';
                  }
                  ...
                  echo '
                   <div class="alert alert-danger alert-dismissible" role="alert">
                   <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</  span></button>
                  <strong>Error!</strong>Please Fill Up Your User Name!</div>';
